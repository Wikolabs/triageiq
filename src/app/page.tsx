...
const P = {
  ...
  content: {
    fr: {
      ...
      metrics: [
        { value: "3x", label: "resolution plus rapide" },
        { value: "92%", label: "precision routage" },
        { value: "-40%", label: "escalades inutiles" },
        { value: "0ms", label: "latence triage" },
      ],
      features: [
        { icon: "🎯", title: "Classification IA multi-criteres", desc: "Priorite, urgence, type, sentiment, langue, produit — TriageIQ analyse chaque dimension en fraction de seconde pour un tri parfait." },
        { icon: "🧠", title: "Routage par expertise", desc: "Chaque ticket est assigne a l'agent ayant la meilleure expertise, disponibilite et historique de resolution sur le sujet." },
        { icon: "⏱️", title: "SLA automatique", desc: "Les delais sont geres selon la priorite. Alertes proactives avant que le SLA ne soit compromis." },
      ],
      steps: [
      ...
      footerTagline: "Triage IA pour equipes support B2B",
    },
    en: {
      langLabel: "EN",
      tagLabel: "Smart triage · AI prioritization · Zero friction",
      taglines: ["Right tickets.", "Right teams.", "Right moment."],
      taglineAccentIdx: 2,
      desc: "TriageIQ analyzes, classifies and routes every ticket to the right agent in milliseconds — priority, urgency, matched expertise, fully automated.",
      navLinks: [
      ...
      metrics: [
        ...
        { value: "-40%", label: "useless escalations" },
        { value: "0ms", label: "triage latency" },
      ],
      features: [
        { icon: "🎯", title: "Multi-criteria AI classification", desc: "Priority, urgency, type, sentiment, language, product — TriageIQ analyzes every dimension in a fraction of a second for perfect sorting." },
        { icon: "🧠", title: "Expertise-based routing", desc: "Every ticket is assigned to the agent with the best expertise, availability and resolution history on the topic." },
        { icon: "⏱️", title: "Automatic SLA", desc: "Deadlines are managed by priority. Proactive alerts before the SLA gets compromised." },
      ],
      steps: [
        { num: "01", title: "One-click helpdesk integration", desc: "Zendesk, Freshdesk, Jira Service Desk, HubSpot — TriageIQ installs with no manual rule configuration." },
        { num: "02", title: "AI model trained on your tickets", desc: "TriageIQ analyzes your last 6 months of tickets to learn your categories, priorities and routing patterns." },
        { num: "03", title: "Autonomous triage activated", desc: "Every ticket is automatically classified and routed. Your agents only receive tickets matching their expertise." },
      ],
      persuasion: {
        sectionTag: "Why now",
        title: "Your best agents spend their days on the wrong tickets.",
        paragraphs: [
          { type: "pathos", text: "Monday 9:12am. Your best support engineer, the one who fixes critical bugs in 20 minutes, is answering a password reset request for the third time this morning. Meanwhile, an enterprise customer worth 240k EUR MRR has been waiting 47 minutes — their ticket is stuck in a junior agent's queue. The manager doesn't know yet. Neither does the CSM. The escalation will fire at 11am, the customer will call their AM at 11:05, and the entire week will burn on firefighting." },
          { type: "logos", text: "Zendesk reported in 2025 that 67% of B2B tickets are misrouted on first pass, generating an average 3.2 reassignments before resolution. Forrester estimates each misroute costs 23 EUR in agent time and lifts churn risk by 14%. McKinsey measured that support teams with AI triage close tickets 2.8x faster and cut escalations by 41%. Manual triage is no longer viable above 500 tickets/day." },
          { type: "ethos", text: "Wikolabs has been building production AI agents since 2023 for B2B scale-ups, family offices and regulated fintechs. We burned our fingers on the same problems you face: hallucinating pipelines, ignored briefs, abandoned dashboards. TriageIQ is what we built for our own demanding customers before bringing it to market." },
          { type: "solution", text: "Concretely: TriageIQ plugs into Zendesk, Freshdesk or Jira in an hour, analyzes your last 6 months of tickets to learn your categories and patterns, then takes over. Every incoming ticket is scored on 47 criteria and routed to the agent whose expertise, load and resolution history maximize close speed. Result: 3x faster resolution, 92% routing accuracy, -40% useless escalations." },
        ],
      },
      ctaTitle: "Your next tickets, sorted in milliseconds",
      ctaDesc: "One-click integration. Model trained within 24h. No credit card.",
      ctaPrimary: "Book a call",
      ctaWhatsApp: "WhatsApp",
      ctaDemo: "Request a demo",
      ctaSoonBadge: "Soon",
      footerTagline: "AI ticket triage for B2B support teams",
    },
  },
};
