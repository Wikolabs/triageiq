...
export const metadata: Metadata = { title: "TriageIQ — Triage et routage intelligent de tickets par IA", description: "3x plus rapide, 92% de precision. TriageIQ classe et route chaque ticket vers le bon agent en millisecondes." };
